...
int crossDeltaProfit(std::vector<std::vector<int>> &Matrix, std::vector<int> &CycleA, std::vector<int> &CycleB, int swapIndexA, int swapIndexB)
{
	...
	int beforePartValue = Matrix[cyclePointsA[1]][cyclePointsA[0]] + Matrix[cyclePointsA[1]][cyclePointsA[2]] + Matrix[cyclePointsB[1]][cyclePointsB[0]] + Matrix[cyclePointsB[1]][cyclePointsB[2]];

	int afterPartValue = Matrix[cyclePointsA[1]][cyclePointsB[0]] + Matrix[cyclePointsA[1]][cyclePointsB[2]] + Matrix[cyclePointsB[1]][cyclePointsA[0]] + Matrix[cyclePointsB[1]][cyclePointsA[2]];
...
int localPointsSwapProfit(std::vector<std::vector<int>> &matrix, std::vector<int> &cycle, int swapIndexA, int swapIndexB)
{
	...
	if (A1Max != A2 and A2Max != A1)
		DeltaA = matrix[A1Min][A2] + matrix[A1Max][A2] + matrix[A2Min][A1] + matrix[A2Max][A1] - matrix[A1Min][A1] - matrix[A1Max][A1] - matrix[A2Min][A2] - matrix[A2Max][A2];
